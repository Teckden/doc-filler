...
export const uk = {
  ...
  presets: {
    ...
    empty:
      'Ще немає добірок. Створіть одну — і кожне поле з відповідною назвою стане випадним списком.',
    ...
    fieldKeyHelp:
      'Будь-яке поле шаблону з цією назвою використовуватиме ці опції. Виберіть зі знайдених полів або введіть назву.',
    options: 'Опції',
    ...
    deleteBody:
      'Це видалить «{{name}}» з вашої бібліотеки. Уже заповнені поля збережуть свої значення. Цю дію не можна скасувати.',
    ...
    selectPlaceholder: 'Виберіть або введіть значення…',
    searchPlaceholder: 'Шукайте або введіть довільне значення…',
    noMatch: 'Немає відповідної опції',
    useCustom: 'Використати довільне значення: «{{value}}»',
    clearValue: 'Очистити значення',
    custom: 'довільне',
    pickOne_one: 'Збігається {{count}} добірка — виберіть одну',
    pickOne_few: 'Збігаються {{count}} добірки — виберіть одну',
    pickOne_many: 'Збігається {{count}} добірок — виберіть одну',
    pickOne_other: 'Збігається {{count}} добірки — виберіть одну',
  },
  footer: {
    source: 'Вихідний код',
  },

...
export const en = {
  ...
  templates: {
    ...
    searchPlaceholder: 'Search {{count}} templates…',
    searchNoMatch: 'No template matches your search',
    groups: {
      ungrouped: 'Ungrouped',
      chip: 'Group',
      chipAria: 'Change group for {{name}}',
      expand: 'Expand {{name}}',
      collapse: 'Collapse {{name}}',
      rename: 'Rename group {{name}}',
      panelTitle: 'Group for this template',
  ...
  upload: {
    ...
    groupHint: 'Type a name — a new group is created if it doesn’t exist yet.',
  },
  rename: {
